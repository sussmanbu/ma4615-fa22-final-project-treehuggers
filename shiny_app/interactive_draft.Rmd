...
map_kids_v_adults <- CA_counties %>% left_join(parks_asthmaCA_kids_v_adults_countystats, by = "county_name")

map_race_ethnicity <- CA_counties %>% left_join(parks_asthmaCA_race_ethnicity_countystats, by = "county_name")

map_kids <- CA_counties %>% left_join(parks_asthmaCA_kids_countystats, by = "county_name")
  
map_kids2 <- CA_counties %>% left_join(parks_asthmaCA_kids_2_countystats, by = "county_name")
