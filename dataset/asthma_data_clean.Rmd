...
write_rds(asthmaCA, "asthmaCA_kids.RData")
```
...
write_rds(CAasthma, "asthmaCA_race_ethnicity.RData")
#head(CAasthma)
```
...
write_rds(Cali_asthma, "asthmaCA_kids_2.RData")
#head(Cali_asthma)
```
...
write_rds(asthma_Cali, "asthmaCA_kids_v_adults.RData")
#head(asthma_Cali)
```
