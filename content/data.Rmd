...
```
  ...
  Descriptions of the variables for this dataset can be found in the table below. Because this dataset is used as a dictionary, it was not extensively analyzed. It was used solely to identify shared ground around which to join the other two datasets. 
 
``` {r echo = FALSE}
ffeic_vars = tibble(
  "Variable Name" = c("TYPE", "FULLCODE", "STATE", "COUNTY", "TRACT", "SHEETS"), 
  "Description" = c("denotes whether the land is a tract, county, block, or other unit (for all data used, the type is TRACT", "entire identifying code of the tract: state code, county code, tract number with no spaces or underscores", "state where tract is located (California's code is 06)", "county where tract is located", "individual tract number", "notes where this data was located in the original PDF" )
)
