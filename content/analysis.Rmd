...
## Data Analysis Motivation
	...
	The goal of this data analysis is to identify California counties with high air pollution and assess whether these areas have different access to open green space than areas with lower air pollution. We’ll also be exploring how hospitalizations rates for asthma differ across these counties. Although this metric is not a perfect measure of air pollution, it is strongly linked, and California county data on asthma hospitalization rates is available. Within asthma hospitalization rates, we’ll look specifically at age groups and race to assess the varied hospitalization rates of different groups. Racial makeup of a county is often correlated with socioeconomic status, and therefore we hope to examine whether areas with a greater POC (people of color) population have both higher hospitalization rates and less green space. However, it’s important to note that race is certainly not an exact metric for socio-economic status. 

To assess access to open green space, the proportion of county area which is parkland and the number of parks per county are used. Both are included because they look at green space in two different ways. To get the best results, both should be considered. Park land data is an imperfect measure of tree or plant coverage because urban parks can contain few plants. Rural regions can have large areas of plant coverage remaining in private hands, and these areas can improve air quality despite not being open to the public. However, parks data is publicly available, and does generally give a good idea of the number of parks most public citizens in a county should have access to, as well as the area that these public green spaces cover. 

Some of the major questions we are interested in answering include: Does a higher amount of open green spaces or a higher number of public parks correlate to lower asthma levels across different California counties? What are the differences in racial and age makeup of hospitalizations across counties? What is the relationship between the racial makeup of asthma hospitalizations and the amount of greenspace in a county? What is the relationship between age makeup of hospitalizations and greenspace? Is there a difference in the relationship between number of open parks and asthma hospitalization rate, and proportion of park land and asthma hospitalization rate? Which serves as a better predictor?
