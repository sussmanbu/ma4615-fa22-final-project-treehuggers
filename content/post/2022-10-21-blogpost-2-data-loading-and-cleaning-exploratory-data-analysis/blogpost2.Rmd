...
authors: []
series: []
lastmod: '2022-10-21T23:09:57-04:00'
featuredVideo: ~
featuredImage: ~
---
...
```{r}
library(tidyverse)
tract_ca <- read.csv(dataset/"nanda_parks_tract_2018_01P.csv") %>% 
...
```{r}
asthma <- read.csv(dataset/"asthma_hospitalization_rates_by_county_2015_2019.csv")
