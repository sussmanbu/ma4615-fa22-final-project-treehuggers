...
ggplotly(nocala %>% ggplot(aes(y = number_hospitalizations, x = age_adjusted_hospitalization_rate, col = county_name)) + geom_point() + labs(y = "Number of Hospitalizations", x = "Hospitalization Rate", title = "Asthma Hopitalization Rates & Numbers", color = "County"))
```
